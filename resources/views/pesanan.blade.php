                                ...
                                <tbody>
                                    @foreach ($pesanan as $item)
                                        <tr>
                                          ...
                                          <td>
                                            {{ $item->nama_customer }} (no meja: {{ $item->getMeja?$item->getMeja->nama:'Pesan dari kasir' }})
                                          </td>
                                          <td>
                                            @if ($item->stts == 0)
                                          ...
                                          <td>
                                            ...
                                            @elseif ($item->stts == 2)
                                            <a href="{{ route('proses.order', $item->id) }}" class="btn btn-sm btn-success"><i class="fa fa-check"></i></a>
                                            @endif
