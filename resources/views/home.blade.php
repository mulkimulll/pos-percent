            ...
            <div class="col-sm-5">
                <form action="{{ route('home') }}" method="GET" class="form-inline ml-0 ml-sm-3">
                    <div class="input-group input-group-sm">
                        <input class="form-control form-control-navbar" type="search" name="cari" placeholder="cari menu"
                            aria-label="Search">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="alert alert-warning" role="alert">
                    <i class="far fa-bell"></i> {{$carts->nama}} berhasil di masukkan ke keranjang
                </div>
                @endif
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-6">
                <div class="card card-body">
                    <div
                        ...
                        <div class="mr-2 mb-3 mb-lg-0"> <img src="{{$item->gambar}}" width="150" height="150" alt="">
                        </div>
