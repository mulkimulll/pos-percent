            ...
            <div class="col-md-6">
                <div class="card card-body">
                    <div
                        ...
                        <div class="mr-2 mb-3 mb-lg-0"> <img src="{{ asset($item->gambar) }}" width="150" height="150"
                                alt="">
                        </div>
                        <div class="media-body">
                            <h6 class="media-title font-weight-semibold"> <a href="#" data-abc="true">{{ $item->nama
                                    }}</a> </h6>
                        ...
                        <div class="mt-3 mt-lg-0 ml-lg-3 text-center">
                            ...
                            <form action="{{ url('/add-to-cart') }}" method="POST">
                                ...
                                <button class="btn btn-sm btn-primary mt-4 text-white"><i class="fas fa-cart-plus"></i>
                                    beli</button>
                            </form>
                            @else
                            <form action="{{ url('/add-to-cart-cust/'.$id_meja) }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_produk" value="{{ $item->id }}">
                                <input type="hidden" name="harga" value="{{ $item->harga }}">
                                <button class="btn btn-sm btn-primary mt-4 text-white"><i class="fas fa-cart-plus"></i>
